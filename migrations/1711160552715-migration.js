...
module.exports = class Migration1711160552715 {
    name = 'Migration1711160552715'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "tbl_creator_video" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" character varying(100) NOT NULL, "desc" text, "create_time" integer, "text_extra" jsonb, "suggested_words" jsonb, "potential_categories" jsonb, "address" character varying(255), "like_count" bigint, "comment_count" bigint, "share_count" bigint, "view_count" bigint, "collect_count" bigint, "creator_id" character varying(100) NOT NULL, CONSTRAINT "PK_00f231c0147c1399d954d322633" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tbl_creator" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" character varying(100) NOT NULL, "unique_id" character varying(100) NOT NULL, "nick_name" character varying(100), "tt_seller" boolean, "language" character varying(100), "avatar" character varying, "private" boolean, "verified" boolean, "visibility" boolean NOT NULL DEFAULT false, "description" character varying, "bio_link" character varying(255), "email" character varying(255), "phone" character varying(255), "instagram" character varying(255), "follower_count" bigint, "like_count" bigint, "video_count" bigint, "view_count" bigint, "comment_count" bigint, "share_count" bigint, "collect_count" bigint, "update_count" integer NOT NULL DEFAULT '0', "country_code" character varying(10), CONSTRAINT "UQ_459d36f306d2f3026dd36b856f4" UNIQUE ("unique_id"), CONSTRAINT "PK_72efe8eecd96cad56db1ac4c7bf" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tbl_tiktok_hashtag" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "id" character varying NOT NULL, "name" character varying(255) NOT NULL, "is_promoted" boolean, "publish_count" bigint, "video_views" bigint, "trend" jsonb, "update_count" integer NOT NULL DEFAULT '0', "country_code" character varying(10), "industry_id" character varying(255), CONSTRAINT "UQ_afe39941628e99f323b358673a4" UNIQUE ("name"), CONSTRAINT "PK_6edc3649f73942a4261b2b2587d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tbl_creator_video" ADD CONSTRAINT "FK_b20e7ed55fb706771abfdb88170" FOREIGN KEY ("creator_id") REFERENCES "tbl_creator"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "tbl_creator_video" DROP CONSTRAINT "FK_b20e7ed55fb706771abfdb88170"`);
        ...
        await queryRunner.query(`DROP TABLE "tbl_creator_video"`);
    }
}
